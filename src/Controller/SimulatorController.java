...
public class SimulatorController {
    ...
    public void startTimer() { // Schakeld de tick timer aan
            tickTimer.start();
    }
    ...
    private void carsEntering(CarQueue queue){
    	...
    	while (queue.carsInQueue()>0 && 
    			simulatorModel.getNumberOfOpenSpots()>0 &&
    			i<enterSpeed) {
            Car car = queue.removeCar();        // deze regel haalt de auto uit de queue.
            Controller.Location freeLocation = simulatorModel.getFirstFreeLocation();       //deze haalt de eerste vrije plek op.
    ...
    private void carsReadyToLeave(){
        ...
        Controller.Car car = simulatorModel.getFirstLeavingCar();       //pakt auto vooraan de rij van vertrekkende autos.
        while (car!=null) {
            ...
            car = simulatorModel.getFirstLeavingCar();
        }
    }
